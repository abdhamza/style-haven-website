...
const navBar = document.querySelector(".header"),
    navBtn = document.querySelector(".header_btn"),
    sections = document.querySelectorAll("section[id]"),
    newContent = document.querySelector(".new_products"),
    shopContent = document.querySelector(".shop_products"),
    trendingContent = document.querySelector(".trending_products"),
    shopCategories = document.querySelectorAll(".shop_category"),
...
const homeSwiper = new Swiper(".home_content", {
    loop: true,
    effect: "fade",
    speed: 2000,
...
async function renderNewProducts() {
    ...
    productCards.forEach((product) => {
        product.classList.add("new_product");
    ...
    /* Swiper JS */
    const newSwiper = new Swiper(".new_content", {
        slidesPerView: 4,
        spaceBetween: 20,
        loop: true,
        grabCursor: true,
...
async function renderShopProducts() {
    ...
    productCards.forEach((product) => {
        product.classList.add("shop_product");
        const image = product.querySelector("img");
        product.addEventListener("mouseover", () => {
            if (product.dataset.image2 != "undefined") {
                image.src = product.dataset.image2;
    ...
    /* ScrollReveal JS */
    sr.reveal(".shop_product", { interval: 100 });
}
...
shopCategories.forEach((category) => {
    category.addEventListener("click", () => {
        ...
        const shopProducts = document.querySelectorAll(".shop_product");
...
async function renderTrendingProducts() {
    ...
    /* Swiper JS */
    const trendingSectionSwiper = new Swiper(".trending_content", {
        loop: true,
        effect: "fade",
        speed: 600,
        allowTouchMove: false,
...
/* ScrollReveal JS */
sr.reveal(".brands_logo", { interval: 100 });

/* ============== Footer ============== */

/* ScrollReveal JS */
sr.reveal(".footer_col", { interval: 100 });
...
function activeScroll() {
    ...
    sections.forEach((section) => {
        const sectionTop = section.offsetTop - 16,
            ...
            link = document.querySelector(`.header_link a[href='#${section.id}'`);
...
window.addEventListener("load", () => {
    ...
    document.querySelector(".home_slide").classList.add("reveal");
});
